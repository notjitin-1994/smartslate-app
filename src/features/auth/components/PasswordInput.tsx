  ...
  return (
    <div className="space-y-2">
      ...
      <div className="group animate-fade-in-up relative">
        <input
          className="focus:ring-primary focus:border-primary w-full rounded-full border border-white/10 bg-white/5 px-5 py-3 pr-14 text-sm text-white placeholder-white/40 ring-0 transition outline-none focus:ring-[1.2px]"
        ...
        <button
          ...
          className="pressable absolute inset-y-0 right-1 my-auto inline-flex h-9 w-9 items-center justify-center rounded-full text-white/60 transition-colors hover:text-white hover:bg-white/10"
